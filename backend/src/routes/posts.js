...
export function postsRoutes(app) {
    ...
    app.post('/api/v1/posts', requireAuth, async (req, res) => {
        try {
            // extract userId from the subject (sub) claim from jwt. It's placed into the 'auth' property within the request. Refer to services/users.js loginUser function
